 ...
 */
tuple[str,str] translate_get_verb_next(list[list[GenerationVerbConcretized]] verbs_concretized, int index) {
 ...
 */
str translate_get_verb_current(list[GenerationVerbConcretized] subchunk) {
    return subchunk[0].name;
}
