...
void main() {
    ...
    loc DemoDir = |project://automatedpuzzlescript/DaedaLe/src/PuzzleScript/Tutorials/TutorialGames|;
	...
	game = load(|project://automatedpuzzlescript/DaedaLe/bin/PuzzleScript/Tutorials/demo/blockfaker.PS|);
