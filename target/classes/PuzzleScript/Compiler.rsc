...
alias Rule = tuple[
	...
	list[str] left,
	list[str] right,
	list[list[RuleContent]] converted_left,
	list[list[RuleContent]] converted_right,
	int used,
	RuleData original
];
...
Rule compile_rulepart_left(Rule rule, Engine engine, list[RuleContent] left_contents, list[RuleContent] right_contents){
...
Rule compile_rulepart_right(Rule rule, Engine engine, list[RuleContent] left_contents, list[RuleContent] right_contents){
	list[list[str]] compiled_layer = [];
	list[set[str]] layers = engine.layers;
...
Rule compile_rulepart(Rule rule, Engine engine, list[RuleContent] left, list[RuleContent] right){
...
list[RuleContent] convert_rulepart(RulePart p: part(list[RuleContent] _), Rule rule, Checker c, Engine engine, bool is_pattern) {
